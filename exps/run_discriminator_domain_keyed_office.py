...
sys.argv = ["run_discriminator_domain_keyed_office"]
args = args_parser()
...
if os.path.isdir("/kaggle/working"):
    drive_base = "/kaggle/working/FedPall/limitation_2/discriminator_domain_keyed_office"
elif os.path.isdir("/content/drive/MyDrive"):
    drive_base = "/content/drive/MyDrive/FedPall/limitation_2/discriminator_domain_keyed_office"
else:
    raise RuntimeError(
...
for seed in seeds:
    ...
    print(f"Running setting=discriminator+domain_keyed_proto(office) seed={seed} (checkpoint: {checkpoint_path})")
