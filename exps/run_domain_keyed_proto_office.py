...
sys.argv = ["run_domain_keyed_proto_office"]
args = args_parser()
...
if os.path.isdir("/kaggle/working"):
    drive_base = "/kaggle/working/FedPall/limitation_2/domain_keyed_proto"
elif os.path.isdir("/content/drive/MyDrive"):
    drive_base = "/content/drive/MyDrive/FedPall/limitation_2/domain_keyed_proto"
else:
    raise RuntimeError(
...
for seed in seeds:
    ...
    print(f"Running setting=domain_keyed_proto seed={seed} (checkpoint: {checkpoint_path})")
