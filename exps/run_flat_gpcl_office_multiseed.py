...
sys.argv = ["run_flat_gpcl_office_multiseed"]
...
drive_base = "/content/drive/MyDrive/FedPall/limitation_2/flat_gpcl_office"
...
print("  baseline(neither fix, no grouping):         52.11%")
print("  B = domain-keyed-proto alone:                52.26%")
print("  discriminator-fix alone:                      54.81%")
print("  C (discriminator-fix+domain_keyed_proto):     52.67%")
print("  D (C+Layer2 consumption):                     55.13%")
