...
sys.argv = ["run_discriminator_fix_alone_pacs"]
args = args_parser()
...
if os.path.isdir("/kaggle/working"):
    ...
    base_dir = "/content/drive/MyDrive/FedPall/limitation_2/discriminator_fix_alone_pacs"
else:
    raise RuntimeError(
...
for seed in seeds:
    ...
    tag = f"discriminator_fix_alone_pacs_seed{seed}"
    ...
    print(f"Running setting=discriminator-fix ALONE (PACS) seed={seed} (checkpoint: {checkpoint_path})")
...
print("\nAll seeds done.")
print("\nreference points (PACS, from Limitation2_verification_results.pdf, no robust-standard yet):")
