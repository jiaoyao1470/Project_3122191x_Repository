...
sys.argv = ["run_baseline_domainswap_amazon_office"]
args = args_parser()
...
print("=" * 78)
print(f"DOMAIN-SWAP PARTITION (AMAZON) -- BASELINE (no fix, no StrongAug) seed={args.seed}")
...
_tag = f"baseline_domainswap_M4amazon_seed{args.seed}"
