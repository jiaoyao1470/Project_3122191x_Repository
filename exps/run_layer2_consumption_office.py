...
sys.argv = ["run_layer2_consumption_office"]
args = args_parser()
...
if os.path.isdir("/kaggle/working"):
    drive_base = "/kaggle/working/FedPall/limitation_2/layer2_consumption_office"
elif os.path.isdir("/content/drive/MyDrive"):
    drive_base = "/content/drive/MyDrive/FedPall/limitation_2/layer2_consumption_office"
else:
    raise RuntimeError(
...
print("  domain-keyed-proto alone(3-seed): 52.26%")
print("  C (Layer1 only, seed0):           52.03%  <- worse than baseline")
print("  66.64% ceiling (no fragmentation)")
