...
sys.argv = ["run_baseline_relog_pacs"]
args = args_parser()
...
if os.path.isdir("/kaggle/working"):
    ...
    base_dir = "/content/drive/MyDrive/FedPall/limitation_2/baseline_relog_pacs"
else:
    raise RuntimeError(
...
for seed in seeds:
    ...
    tag = f"baseline_relog_pacs_seed{seed}"
    ...
    print(f"Running setting=baseline(PACS, neither fix) seed={seed} (checkpoint: {checkpoint_path})")
